    ...
    <div class="pipeline-page">
        <header>
            <div class="space-y-4">
                ...
                <p>This pipeline processes text images in multiple Indic languages, extracting text and performing
                    language
                    classification, text recognition, and transliteration.</p>
            </div>
        </header>
...
export default {
    data() {
        return {
            steps: [
                { title: "Dataset Preparation", description: "Gather and preprocess text images in Tamil, Malayalam, and Hindi" },
                { title: "Object Detection", description: "Detect regions of interest from preprocessed images" },
                { title: "Language Classification", description: "Classify text regions by language using a CNN model" },
                { title: "Text Recognition", description: "Recognize text using a CRNN modelRecognize text using a CRNN model" },
                { title: "Transliteration", description: "Convert recognized text to English using a transliteration model" }
            ],
            datasets: [
                { title: "Indic Language Dataset", description: "Contains annotated text images for Tamil, Malayalam, and Hindi" },
                { title: "Text Detection Dataset", description: "Images with labeled bounding boxes for text detection" }
            ],
            boxColors: [
